...
export const CATEGORY_CONFIG = {
  ...
  cafe: { label: "Café", color: "#019EE0", bg: "#fef3e2" },
  bar: { label: "Bar", color: "#B1CFED", bg: "#f5eafb" },
  bakery: { label: "Bakery", color: "#F2BA03", bg: "#e9f7ef" },
  street_food: { label: "Street Food", color: "#F18A10", bg: "#eaf4fb" },
  club: { label: "Club", color: "#C33124", bg: "#fbe9e7" },
};
